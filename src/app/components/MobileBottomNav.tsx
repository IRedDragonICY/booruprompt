...
export function MobileBottomNav({ active, onSelectExtractor, onSelectImage, onSelectBooruList, onSelectStatus, onOpenSettings, highlightSettings = false }: MobileBottomNavProps) {
