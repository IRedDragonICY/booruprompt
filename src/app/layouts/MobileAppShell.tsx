...
export function MobileAppShell({
    ...
    return (
        <>
            ...
            <MobileBottomNav active={active} onSelectExtractor={selectExtractor} onSelectImage={selectImage} onOpenSettings={openSettings} highlightSettings={highlightSettings} />
        </>
    );
}
