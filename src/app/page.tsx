...
// Default fetch mode: use server on web (http/https), use client proxy inside Tauri/static export
const isTauriEnv = typeof window !== 'undefined' && (('__TAURI__' in window) || window.location.protocol === 'file:');
